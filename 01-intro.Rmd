...
Un graphique en data science sert généralement à répondre à une question. Par exemple :
...
Puis, nous allons charger la librairie ggplot2 afin de disposer des fonction de la librairie et créer notre premier graphique. 
