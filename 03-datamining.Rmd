...
* 4 ou 5 classes  de couleurs, tailles et de styles  sont  facilements distinguables http://jfly.iam.u-tokyo.ac.jp/color/
...
* Quelles sont les plus grandes différences avec la carte précedente qui utilisait `leaflet`  ? 
...
La grande force du paquet `plotly` est de pouvoir transformer vos graphiques que vous avez crée au cours précedent `ggplot`, qui sont statique
